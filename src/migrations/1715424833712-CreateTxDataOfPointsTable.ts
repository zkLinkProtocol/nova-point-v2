...
export class CreateTxDataOfPointsTable1715424833712 implements MigrationInterface {
    name = 'CreateTxDataOfPointsTable1715424833712'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "transactionDataOfPoints" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userAddress" bytea NOT NULL, "contractAddress" bytea NOT NULL, "tokenAddress" bytea NOT NULL, "decimals" smallint NOT NULL, "price" character varying(100) NOT NULL, "quantity" bigint NOT NULL, "nonce" character varying(100) NOT NULL, "timestamp" TIMESTAMP NOT NULL, "txHash" character varying(100) NOT NULL, "blockNumber" bigint NOT NULL, CONSTRAINT "PK_085c4219b4ec67def6f6c4f2a3c" PRIMARY KEY ("userAddress", "contractAddress", "tokenAddress", "decimals"))`);
