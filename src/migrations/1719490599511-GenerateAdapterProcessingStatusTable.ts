...
export class GenerateAdapterProcessingStatusTable1719490599511 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tvlProcessingStatus" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "adapterName" character varying NOT NULL, "blockNumber" integer NOT NULL, "adapterProcessed" boolean NOT NULL DEFAULT false, "pointProcessed" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_8bad5c20846b2c74b028a71f1dd" PRIMARY KEY ("adapterName", "blockNumber"))`);
