...
export class CreateSequenceForPointOfLp1713752965702 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE SEQUENCE "bridgeStatisticalBlockNumber" AS BIGINT MINVALUE 1`);
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP SEQUENCE "bridgeStatisticalBlockNumber"`);
  }
}
